  ...
  return (
    <div className="fixed bottom-28 right-8 w-56 text-right z-[200]">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className=" h-12 w-12 flex items-center justify-center rounded-full bg-primary shadow-idle text-white">
            <TiPlus color="white" size={ICON_SIZE} />
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
        ...
        >
          <Menu.Items className="absolute bottom-14 right-0 mb-2 w-56 origin-bottom-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
