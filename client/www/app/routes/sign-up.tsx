    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow relative">
        ...
        <div className="relative flex flex-col items-center z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-full">
          ...
          <div
            className="relative rounded-lg bg-white shadow-xl min-h-[535px] min-w-[335px] sm:min-w-[374px] md:min-w-[400px]">
            <div className="absolute w-full max-w-md mx-auto space-y-6">
              {!isLoaded ? (
                <>
